/**
 * RandomTeamController - Controller cho chức năng chia team random
 */
...
export class RandomTeamController {
    constructor() {
        this.game = new Game();
        this.game.setGameMode('random');
    ...
    render() {
        ...
        if (mainContent) {
            mainContent.innerHTML = `
                <header>
                    <h1><i class="fas fa-random"></i> Lập Team Random</h1>
                    <p>Chia team hoàn toàn ngẫu nhiên - Vui vẻ và thử thách!</p>
                </header>
    ...
    showResults() {
        ...
        if (balanceInfo) {
            this.resultView.displayBalanceInfo(balanceInfo, 'random');
        }
